...
public class PersonalComputer extends Appliance {
	@XmlElement
	...
	public PersonalComputer(double price, int batteryCapacity, double displayInches, int memoryRom, int flashMemoryCapacity,
							String color) {
		super(price);
